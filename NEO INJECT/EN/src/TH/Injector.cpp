...
int main() {
    ...
    std::cout << "[+] Enter the DLL's name: (DLL1.dll, hack.dll etc.)\n " << std::endl;
    std::cout << ">> ";
    std::cin >> dllName;
    ...
    {
        int click = MessageBoxA(NULL, "The file must have a \".dll\" extension!", what.c_str(), MB_RETRYCANCEL | MB_ICONERROR);
        switch (click)
        {
        case IDRETRY:
            goto retry;
    ...
    {
        int click = MessageBoxA(NULL, "DLL NOT FOUND!", dllName, MB_RETRYCANCEL | MB_ICONERROR);
        switch (click)
        {
        case IDRETRY:
            goto retry;
    ...
    retryApp:
    std::cout << "\n[+] Enter the program's name: (notepad.exe, csgo.exe etc.)\n " << std::endl;
    std::cout << ">> ";
    std::cin >> app;
    ...
    {
        int click = MessageBoxA(NULL, "The file must have a \".exe\" extension!", what2.c_str(), MB_RETRYCANCEL | MB_ICONERROR);
        switch (click)
        {
        case IDRETRY:
            goto retryApp;
    ...
    std::cout << "\n\n[+] PROCESS FOUND >> (" << app << ") PID: " << pid << std::endl;
    ...
    MessageBoxA(NULL, "DLL ACTIVATED!", app.c_str(), MB_OK | MB_ICONINFORMATION);
